...
public class Order implements Tradable {
    ...
    private void setUser(String user) throws NullParameterException, BadParameterException {
    ...
    private void setOriginalVolume(int originalVolume) throws BadParameterException {
    ...
    public String toString() {
        return user + " order: " + side + " " + product + " at " + price + ", Orig Val: "
                + originalVolume + ", Rem Vol: " +  remainingVolume + ", Fill Vol: " +
                filledVolume + ", CXL Vol: " + cancelledVolume + ", ID: " + id;
    }
